...
/**
 * The end-to-end happy path across all three roles: HTTP → {@code payment-events}
 * → debit → {@code payment-results} → reconciliation CONFIRMED. Nothing here
 * calls a service method directly; every step is driven by a real record moving
