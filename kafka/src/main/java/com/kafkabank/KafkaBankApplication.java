 ...
 * {@code @Scheduled} sweep is never invoked, and the outbox is correct only for as
 * long as the after-commit shortcut keeps working. The failure would be silent.
 */
@EnableScheduling
