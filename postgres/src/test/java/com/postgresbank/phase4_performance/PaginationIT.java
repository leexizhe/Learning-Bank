...
/**
 * A transaction-history endpoint that returns every posting an account has ever made doesn't scale - this asserts the
 * endpoint actually respects {@code page}/{@code size} rather than just accepting the parameters and ignoring them,
 * which is an easy way for pagination to look wired up while quietly still loading everything.
 */
