...
/**
 * Two ways to load "these accounts, with their posting history" - same result, very different SQL. {@link
...
public class AccountHistoryService {
    ...
    public int loadNPlusOne(List<Long> accountIds) {
        ...
        for (Account account : loaded) {
            // Each .size() call here is where the extra SELECT fires - the association wasn't fetched with the accounts
            // query above.
