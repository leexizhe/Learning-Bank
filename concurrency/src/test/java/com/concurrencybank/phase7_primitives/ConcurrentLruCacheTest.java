...
class ConcurrentLruCacheTest {
    ...
    /**
     * The property that makes this an LR<b>U</b> cache rather than an LR<b>I</b> one, and the reason {@code get} has to
     * take the write lock: reading {@code a} re-links it as the freshest entry, which changes who gets evicted next.
     * With {@code accessOrder=false} this test fails and {@code a} disappears instead of {@code b}.
     */
    @Test
