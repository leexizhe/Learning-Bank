...
class TellerQueueTest {
  ...
  /**
   * Producers and consumers have to run genuinely concurrently (the queue is smaller than the total
   * item count, so producers block on a full queue until consumers drain it) - {@code
