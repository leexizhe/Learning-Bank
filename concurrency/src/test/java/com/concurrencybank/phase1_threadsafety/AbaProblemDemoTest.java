...
class AbaProblemDemoTest {
    ...
    /**
     * No threads: ABA is a property of the sequence of values, not of timing, so performing A -> B -> A on one thread
     * demonstrates it exactly and deterministically. A stress loop would prove the same thing less clearly.
     */
    @Test
