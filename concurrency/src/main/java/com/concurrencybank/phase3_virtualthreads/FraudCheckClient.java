...
/**
 * Stand-in for a slow external fraud-scoring API. {@code Thread.sleep} here is
 * exactly the point: on a virtual thread it parks the thread cheaply instead
 * of pinning a precious OS thread for the whole call, which is what makes it
 * safe to fan out many of these concurrently.
 */
@Component
