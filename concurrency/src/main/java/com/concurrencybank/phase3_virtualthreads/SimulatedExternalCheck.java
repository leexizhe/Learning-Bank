...
/**
 * The one bit of logic {@code Fraud}/{@code Credit}/{@code Sanctions}CheckClient share: turn a
 * prefix match into a {@link ValidationResult}. Each client still owns its own latency and {@code
 * Thread.sleep} call.
 */
